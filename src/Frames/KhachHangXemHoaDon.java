...
public class KhachHangXemHoaDon extends javax.swing.JFrame {
    ...
    /**
     * Creates new form KhachHangXemHoaDon
     */
    public KhachHangXemHoaDon() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(949, 446));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã đơn hàng", "Ngày đặt", "Tình trạng", "Tài xế", "Hình thức thanh toán", "Địa chỉ nhận", "Phí vận chuyển", "Phí sản phẩm", "Tổng tiền"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        list = DBController.getDonHang("KH01");
        for(DonHang hd:list){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KhachHangXemHoaDon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KhachHangXemHoaDon().setVisible(true);
            }
        });
    }
